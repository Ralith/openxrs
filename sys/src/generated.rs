...
impl StructureType {
    ...
    pub const SPACE_FROM_SPATIAL_GRAPH_NODE_CREATE_INFO_MSFT: StructureType =
        StructureType(1000049000i32);
    pub const HAND_TRACKER_CREATE_INFO_MSFT: StructureType = StructureType(1000051000i32);
    pub const HAND_TRACKER_STATE_MSFT: StructureType = StructureType(1000051001i32);
    pub const HAND_JOINT_SPACE_CREATE_INFO_MSFT: StructureType = StructureType(1000051002i32);
    pub const HAND_JOINT_RADIUS_MSFT: StructureType = StructureType(1000051003i32);
    pub const SYSTEM_HAND_TRACKING_PROPERTIES_MSFT: StructureType = StructureType(1000051004i32);
    pub const HAND_MESH_SPACE_CREATE_INFO_MSFT: StructureType = StructureType(1000052000i32);
    pub const HAND_MESH_UPDATE_INFO_MSFT: StructureType = StructureType(1000052001i32);
    pub const HAND_MESH_MSFT: StructureType = StructureType(1000052002i32);
    pub const SYSTEM_HAND_TRACKING_MESH_PROPERTIES_MSFT: StructureType =
        StructureType(1000052003i32);
    pub const HAND_POSE_TYPE_INFO_MSFT: StructureType = StructureType(1000052004i32);
    pub const SESSION_BEGIN_SECONDARY_VIEW_CONFIGURATION_INFO_MSFT: StructureType =
        StructureType(1000053000i32);
    pub const SECONDARY_VIEW_CONFIGURATION_STATE_MSFT: StructureType = StructureType(1000053001i32);
    pub const FRAME_SECONDARY_VIEW_CONFIGURATIONS_STATE_MSFT: StructureType =
        StructureType(1000053002i32);
    pub const FRAME_END_SECONDARY_VIEW_CONFIGURATION_INFO_MSFT: StructureType =
    ...
    pub const SWAPCHAIN_SECONDARY_VIEW_CONFIGURATION_CREATE_INFO_MSFT: StructureType =
        StructureType(1000053005i32);
    pub const ACTION_STATE_POSE_CONTROLLER_MODEL_MSFT: StructureType = StructureType(1000055000i32);
    pub const CONTROLLER_MODEL_NODE_PROPERTIES_MSFT: StructureType = StructureType(1000055001i32);
    pub const CONTROLLER_MODEL_PROPERTIES_MSFT: StructureType = StructureType(1000055002i32);
    pub const CONTROLLER_MODEL_NODE_STATE_MSFT: StructureType = StructureType(1000055003i32);
    pub const CONTROLLER_MODEL_STATE_MSFT: StructureType = StructureType(1000055004i32);
...
impl fmt::Debug for StructureType {
    fn fmt(&self, fmt: &mut fmt::Formatter) -> fmt::Result {
        let name = match *self {
            ...
            Self::SPACE_FROM_SPATIAL_GRAPH_NODE_CREATE_INFO_MSFT => {
                Some("SPACE_FROM_SPATIAL_GRAPH_NODE_CREATE_INFO_MSFT")
            }
            Self::HAND_TRACKER_CREATE_INFO_MSFT => Some("HAND_TRACKER_CREATE_INFO_MSFT"),
            Self::HAND_TRACKER_STATE_MSFT => Some("HAND_TRACKER_STATE_MSFT"),
            Self::HAND_JOINT_SPACE_CREATE_INFO_MSFT => Some("HAND_JOINT_SPACE_CREATE_INFO_MSFT"),
            Self::HAND_JOINT_RADIUS_MSFT => Some("HAND_JOINT_RADIUS_MSFT"),
            Self::SYSTEM_HAND_TRACKING_PROPERTIES_MSFT => {
                Some("SYSTEM_HAND_TRACKING_PROPERTIES_MSFT")
            }
            ...
            Self::SESSION_BEGIN_SECONDARY_VIEW_CONFIGURATION_INFO_MSFT => {
                Some("SESSION_BEGIN_SECONDARY_VIEW_CONFIGURATION_INFO_MSFT")
            }
            Self::SECONDARY_VIEW_CONFIGURATION_STATE_MSFT => {
                Some("SECONDARY_VIEW_CONFIGURATION_STATE_MSFT")
            }
            Self::FRAME_SECONDARY_VIEW_CONFIGURATIONS_STATE_MSFT => {
                Some("FRAME_SECONDARY_VIEW_CONFIGURATIONS_STATE_MSFT")
            }
            Self::FRAME_END_SECONDARY_VIEW_CONFIGURATION_INFO_MSFT => {
                Some("FRAME_END_SECONDARY_VIEW_CONFIGURATION_INFO_MSFT")
            }
            Self::SECONDARY_VIEW_CONFIGURATION_LAYER_INFO_MSFT => {
                Some("SECONDARY_VIEW_CONFIGURATION_LAYER_INFO_MSFT")
            }
            Self::SWAPCHAIN_SECONDARY_VIEW_CONFIGURATION_CREATE_INFO_MSFT => {
                Some("SWAPCHAIN_SECONDARY_VIEW_CONFIGURATION_CREATE_INFO_MSFT")
            }
            Self::ACTION_STATE_POSE_CONTROLLER_MODEL_MSFT => {
                Some("ACTION_STATE_POSE_CONTROLLER_MODEL_MSFT")
            }
...
impl Result {
    ...
    #[doc = "The spatial graph node of given type was not found."]
    pub const ERROR_SPATIAL_GRAPH_NODE_NOT_FOUND_MSFT: Result = Result(-1000049001i32);
    ...
    #[doc = "The controller model is currently not available."]
    pub const ERROR_CONTROLLER_MODEL_UNAVAILABLE_MSFT: Result = Result(-1000055000i32);
    #[doc = "The controller model key is invalid."]
    pub const ERROR_CONTROLLER_MODEL_KEY_INVALID_MSFT: Result = Result(-1000055001i32);
    pub fn from_raw(x: i32) -> Self {
        Self(x)
    }
    pub fn into_raw(self) -> i32 {
...
impl fmt::Debug for Result {
    fn fmt(&self, fmt: &mut fmt::Formatter) -> fmt::Result {
        let name = match *self {
            ...
            Self::ERROR_SPATIAL_GRAPH_NODE_NOT_FOUND_MSFT => {
                Some("ERROR_SPATIAL_GRAPH_NODE_NOT_FOUND_MSFT")
            }
            ...
            Self::ERROR_CONTROLLER_MODEL_UNAVAILABLE_MSFT => {
                Some("ERROR_CONTROLLER_MODEL_UNAVAILABLE_MSFT")
            }
...
impl ObjectType {
    ...
    #[doc = "XrHandTrackerMSFT"]
    pub const HAND_TRACKER_MSFT: ObjectType = ObjectType(1000051000i32);
    pub fn from_raw(x: i32) -> Self {
        Self(x)
    }
    pub fn into_raw(self) -> i32 {
...
impl fmt::Debug for ObjectType {
    fn fmt(&self, fmt: &mut fmt::Formatter) -> fmt::Result {
        let name = match *self {
            ...
            Self::HAND_TRACKER_MSFT => Some("HAND_TRACKER_MSFT"),
            _ => None,
        };
        fmt_enum(fmt, self.0, name)
    }
...
#[doc = "See [XrHandMSFT](https://www.khronos.org/registry/OpenXR/specs/1.0/html/xrspec.html#XrHandMSFT)"]
#[repr(transparent)]
#[derive(Copy, Clone, Eq, PartialEq)]
pub struct HandMSFT(i32);
impl HandMSFT {
    pub const LEFT: HandMSFT = HandMSFT(1i32);
    pub const RIGHT: HandMSFT = HandMSFT(2i32);
    pub fn from_raw(x: i32) -> Self {
        Self(x)
    }
    pub fn into_raw(self) -> i32 {
...
#[doc = "See [XrHandJointMSFT](https://www.khronos.org/registry/OpenXR/specs/1.0/html/xrspec.html#XrHandJointMSFT)"]
#[repr(transparent)]
#[derive(Copy, Clone, Eq, PartialEq)]
pub struct HandJointMSFT(i32);
impl HandJointMSFT {
    pub const PALM: HandJointMSFT = HandJointMSFT(0i32);
    pub const WRIST: HandJointMSFT = HandJointMSFT(1i32);
    pub const THUMB_METACARPAL: HandJointMSFT = HandJointMSFT(2i32);
    pub const THUMB_PROXIMAL: HandJointMSFT = HandJointMSFT(3i32);
    pub const THUMB_DISTAL: HandJointMSFT = HandJointMSFT(4i32);
    pub const THUMB_TIP: HandJointMSFT = HandJointMSFT(5i32);
    pub const INDEX_METACARPAL: HandJointMSFT = HandJointMSFT(6i32);
    pub const INDEX_PROXIMAL: HandJointMSFT = HandJointMSFT(7i32);
    pub const INDEX_INTERMEDIATE: HandJointMSFT = HandJointMSFT(8i32);
    pub const INDEX_DISTAL: HandJointMSFT = HandJointMSFT(9i32);
    pub const INDEX_TIP: HandJointMSFT = HandJointMSFT(10i32);
    pub const MIDDLE_METACARPAL: HandJointMSFT = HandJointMSFT(11i32);
    pub const MIDDLE_PROXIMAL: HandJointMSFT = HandJointMSFT(12i32);
    pub const MIDDLE_INTERMEDIATE: HandJointMSFT = HandJointMSFT(13i32);
    pub const MIDDLE_DISTAL: HandJointMSFT = HandJointMSFT(14i32);
    pub const MIDDLE_TIP: HandJointMSFT = HandJointMSFT(15i32);
    pub const RING_METACARPAL: HandJointMSFT = HandJointMSFT(16i32);
    pub const RING_PROXIMAL: HandJointMSFT = HandJointMSFT(17i32);
    pub const RING_INTERMEDIATE: HandJointMSFT = HandJointMSFT(18i32);
    pub const RING_DISTAL: HandJointMSFT = HandJointMSFT(19i32);
    pub const RING_TIP: HandJointMSFT = HandJointMSFT(20i32);
    pub const LITTLE_METACARPAL: HandJointMSFT = HandJointMSFT(21i32);
    pub const LITTLE_PROXIMAL: HandJointMSFT = HandJointMSFT(22i32);
    pub const LITTLE_INTERMEDIATE: HandJointMSFT = HandJointMSFT(23i32);
    pub const LITTLE_DISTAL: HandJointMSFT = HandJointMSFT(24i32);
    pub const LITTLE_TIP: HandJointMSFT = HandJointMSFT(25i32);
    pub fn from_raw(x: i32) -> Self {
        Self(x)
    }
    pub fn into_raw(self) -> i32 {
...
impl fmt::Debug for HandJointMSFT {
    fn fmt(&self, fmt: &mut fmt::Formatter) -> fmt::Result {
        let name = match *self {
            Self::PALM => Some("PALM"),
...
#[doc = "See [XrHandTrackerMSFT](https://www.khronos.org/registry/OpenXR/specs/1.0/html/xrspec.html#XrHandTrackerMSFT)"]
#[repr(transparent)]
#[derive(Debug, Copy, Clone, Eq, PartialEq)]
pub struct HandTrackerMSFT(u64);
handle!(HandTrackerMSFT);
#[repr(C)]
#[derive(Copy, Clone)]
...
#[repr(C)]
#[derive(Copy, Clone)]
#[doc = "See [XrSpaceFromSpatialGraphNodeCreateInfoMSFT](https://www.khronos.org/registry/OpenXR/specs/1.0/html/xrspec.html#XrSpaceFromSpatialGraphNodeCreateInfoMSFT) - defined by [XR_MSFT_spatial_graph_bridge_preview](https://www.khronos.org/registry/OpenXR/specs/1.0/html/xrspec.html#XR_MSFT_spatial_graph_bridge_preview)"]
pub struct SpaceFromSpatialGraphNodeCreateInfoMSFT {
    pub ty: StructureType,
    pub next: *const c_void,
    pub spatial_graph_node_type: SpatialGraphNodeTypeMSFT,
    pub node_id_16: u8,
    pub pose: Posef,
}
impl SpaceFromSpatialGraphNodeCreateInfoMSFT {
    pub const TYPE: StructureType = StructureType::SPACE_FROM_SPATIAL_GRAPH_NODE_CREATE_INFO_MSFT;
}
#[repr(C)]
#[derive(Copy, Clone)]
#[doc = "See [XrHandTrackerCreateInfoMSFT](https://www.khronos.org/registry/OpenXR/specs/1.0/html/xrspec.html#XrHandTrackerCreateInfoMSFT) - defined by [XR_MSFT_hand_tracking_preview](https://www.khronos.org/registry/OpenXR/specs/1.0/html/xrspec.html#XR_MSFT_hand_tracking_preview)"]
pub struct HandTrackerCreateInfoMSFT {
    pub ty: StructureType,
    pub next: *const c_void,
    pub hand: HandMSFT,
}
impl HandTrackerCreateInfoMSFT {
    pub const TYPE: StructureType = StructureType::HAND_TRACKER_CREATE_INFO_MSFT;
}
#[repr(C)]
#[derive(Copy, Clone)]
#[doc = "See [XrHandTrackerStateMSFT](https://www.khronos.org/registry/OpenXR/specs/1.0/html/xrspec.html#XrHandTrackerStateMSFT) - defined by [XR_MSFT_hand_tracking_preview](https://www.khronos.org/registry/OpenXR/specs/1.0/html/xrspec.html#XR_MSFT_hand_tracking_preview)"]
pub struct HandTrackerStateMSFT {
    pub ty: StructureType,
    pub next: *mut c_void,
    pub is_active: Bool32,
}
impl HandTrackerStateMSFT {
    pub const TYPE: StructureType = StructureType::HAND_TRACKER_STATE_MSFT;
    #[doc = r" Construct a partially-initialized value suitable for passing to OpenXR"]
    #[inline]
    pub fn out(next: *mut BaseOutStructure) -> MaybeUninit<Self> {
        let mut x = MaybeUninit::<Self>::uninit();
...
#[repr(C)]
#[derive(Copy, Clone)]
#[doc = "See [XrHandJointSpaceCreateInfoMSFT](https://www.khronos.org/registry/OpenXR/specs/1.0/html/xrspec.html#XrHandJointSpaceCreateInfoMSFT) - defined by [XR_MSFT_hand_tracking_preview](https://www.khronos.org/registry/OpenXR/specs/1.0/html/xrspec.html#XR_MSFT_hand_tracking_preview)"]
pub struct HandJointSpaceCreateInfoMSFT {
    pub ty: StructureType,
    pub next: *const c_void,
    pub hand_tracker: HandTrackerMSFT,
    pub joint: HandJointMSFT,
    pub pose_in_joint_space: Posef,
}
impl HandJointSpaceCreateInfoMSFT {
    pub const TYPE: StructureType = StructureType::HAND_JOINT_SPACE_CREATE_INFO_MSFT;
}
#[repr(C)]
#[derive(Copy, Clone)]
#[doc = "See [XrHandJointRadiusMSFT](https://www.khronos.org/registry/OpenXR/specs/1.0/html/xrspec.html#XrHandJointRadiusMSFT) - defined by [XR_MSFT_hand_tracking_preview](https://www.khronos.org/registry/OpenXR/specs/1.0/html/xrspec.html#XR_MSFT_hand_tracking_preview)"]
pub struct HandJointRadiusMSFT {
    pub ty: StructureType,
    pub next: *mut c_void,
    pub radius: f32,
}
impl HandJointRadiusMSFT {
    pub const TYPE: StructureType = StructureType::HAND_JOINT_RADIUS_MSFT;
    #[doc = r" Construct a partially-initialized value suitable for passing to OpenXR"]
    #[inline]
    pub fn out(next: *mut BaseOutStructure) -> MaybeUninit<Self> {
        let mut x = MaybeUninit::<Self>::uninit();
...
#[repr(C)]
#[derive(Copy, Clone)]
#[doc = "See [XrSystemHandTrackingPropertiesMSFT](https://www.khronos.org/registry/OpenXR/specs/1.0/html/xrspec.html#XrSystemHandTrackingPropertiesMSFT) - defined by [XR_MSFT_hand_tracking_preview](https://www.khronos.org/registry/OpenXR/specs/1.0/html/xrspec.html#XR_MSFT_hand_tracking_preview)"]
pub struct SystemHandTrackingPropertiesMSFT {
    pub ty: StructureType,
    pub next: *mut c_void,
    pub supports_hand_tracking: Bool32,
}
impl SystemHandTrackingPropertiesMSFT {
    pub const TYPE: StructureType = StructureType::SYSTEM_HAND_TRACKING_PROPERTIES_MSFT;
    #[doc = r" Construct a partially-initialized value suitable for passing to OpenXR"]
    #[inline]
    pub fn out(next: *mut BaseOutStructure) -> MaybeUninit<Self> {
        let mut x = MaybeUninit::<Self>::uninit();
...
#[repr(C)]
#[derive(Copy, Clone)]
#[doc = "See [XrHandMeshSpaceCreateInfoMSFT](https://www.khronos.org/registry/OpenXR/specs/1.0/html/xrspec.html#XrHandMeshSpaceCreateInfoMSFT) - defined by [XR_MSFT_hand_tracking_mesh_preview](https://www.khronos.org/registry/OpenXR/specs/1.0/html/xrspec.html#XR_MSFT_hand_tracking_mesh_preview)"]
...
#[repr(C)]
#[derive(Copy, Clone)]
#[doc = "See [XrHandMeshUpdateInfoMSFT](https://www.khronos.org/registry/OpenXR/specs/1.0/html/xrspec.html#XrHandMeshUpdateInfoMSFT) - defined by [XR_MSFT_hand_tracking_mesh_preview](https://www.khronos.org/registry/OpenXR/specs/1.0/html/xrspec.html#XR_MSFT_hand_tracking_mesh_preview)"]
...
#[repr(C)]
#[derive(Copy, Clone)]
#[doc = "See [XrHandMeshMSFT](https://www.khronos.org/registry/OpenXR/specs/1.0/html/xrspec.html#XrHandMeshMSFT) - defined by [XR_MSFT_hand_tracking_mesh_preview](https://www.khronos.org/registry/OpenXR/specs/1.0/html/xrspec.html#XR_MSFT_hand_tracking_mesh_preview)"]
...
#[repr(C)]
#[derive(Copy, Clone)]
#[doc = "See [XrHandMeshIndexBufferMSFT](https://www.khronos.org/registry/OpenXR/specs/1.0/html/xrspec.html#XrHandMeshIndexBufferMSFT) - defined by [XR_MSFT_hand_tracking_mesh_preview](https://www.khronos.org/registry/OpenXR/specs/1.0/html/xrspec.html#XR_MSFT_hand_tracking_mesh_preview)"]
...
#[repr(C)]
#[derive(Copy, Clone)]
#[doc = "See [XrHandMeshVertexBufferMSFT](https://www.khronos.org/registry/OpenXR/specs/1.0/html/xrspec.html#XrHandMeshVertexBufferMSFT) - defined by [XR_MSFT_hand_tracking_mesh_preview](https://www.khronos.org/registry/OpenXR/specs/1.0/html/xrspec.html#XR_MSFT_hand_tracking_mesh_preview)"]
...
#[repr(C)]
#[derive(Copy, Clone)]
#[doc = "See [XrHandMeshVertexMSFT](https://www.khronos.org/registry/OpenXR/specs/1.0/html/xrspec.html#XrHandMeshVertexMSFT) - defined by [XR_MSFT_hand_tracking_mesh_preview](https://www.khronos.org/registry/OpenXR/specs/1.0/html/xrspec.html#XR_MSFT_hand_tracking_mesh_preview)"]
...
#[repr(C)]
#[derive(Copy, Clone)]
#[doc = "See [XrSystemHandTrackingMeshPropertiesMSFT](https://www.khronos.org/registry/OpenXR/specs/1.0/html/xrspec.html#XrSystemHandTrackingMeshPropertiesMSFT) - defined by [XR_MSFT_hand_tracking_mesh_preview](https://www.khronos.org/registry/OpenXR/specs/1.0/html/xrspec.html#XR_MSFT_hand_tracking_mesh_preview)"]
...
#[repr(C)]
#[derive(Copy, Clone)]
#[doc = "See [XrHandPoseTypeInfoMSFT](https://www.khronos.org/registry/OpenXR/specs/1.0/html/xrspec.html#XrHandPoseTypeInfoMSFT) - defined by [XR_MSFT_hand_tracking_mesh_preview](https://www.khronos.org/registry/OpenXR/specs/1.0/html/xrspec.html#XR_MSFT_hand_tracking_mesh_preview)"]
...
#[repr(C)]
#[derive(Copy, Clone)]
#[doc = "See [XrSessionBeginSecondaryViewConfigurationInfoMSFT](https://www.khronos.org/registry/OpenXR/specs/1.0/html/xrspec.html#XrSessionBeginSecondaryViewConfigurationInfoMSFT) - defined by [XR_MSFT_secondary_view_configuration_preview](https://www.khronos.org/registry/OpenXR/specs/1.0/html/xrspec.html#XR_MSFT_secondary_view_configuration_preview)"]
pub struct SessionBeginSecondaryViewConfigurationInfoMSFT {
    pub ty: StructureType,
    pub next: *const c_void,
    pub view_configuration_count: u32,
    pub enabled_view_configuration_types: *const ViewConfigurationType,
}
impl SessionBeginSecondaryViewConfigurationInfoMSFT {
    pub const TYPE: StructureType =
        StructureType::SESSION_BEGIN_SECONDARY_VIEW_CONFIGURATION_INFO_MSFT;
}
#[repr(C)]
#[derive(Copy, Clone)]
#[doc = "See [XrSecondaryViewConfigurationStateMSFT](https://www.khronos.org/registry/OpenXR/specs/1.0/html/xrspec.html#XrSecondaryViewConfigurationStateMSFT) - defined by [XR_MSFT_secondary_view_configuration_preview](https://www.khronos.org/registry/OpenXR/specs/1.0/html/xrspec.html#XR_MSFT_secondary_view_configuration_preview)"]
...
#[repr(C)]
#[derive(Copy, Clone)]
#[doc = "See [XrFrameSecondaryViewConfigurationsStateMSFT](https://www.khronos.org/registry/OpenXR/specs/1.0/html/xrspec.html#XrFrameSecondaryViewConfigurationsStateMSFT) - defined by [XR_MSFT_secondary_view_configuration_preview](https://www.khronos.org/registry/OpenXR/specs/1.0/html/xrspec.html#XR_MSFT_secondary_view_configuration_preview)"]
pub struct FrameSecondaryViewConfigurationsStateMSFT {
    pub ty: StructureType,
    pub next: *mut c_void,
    pub view_configuration_count: u32,
    pub states: *mut SecondaryViewConfigurationStateMSFT,
}
impl FrameSecondaryViewConfigurationsStateMSFT {
    pub const TYPE: StructureType = StructureType::FRAME_SECONDARY_VIEW_CONFIGURATIONS_STATE_MSFT;
    #[doc = r" Construct a partially-initialized value suitable for passing to OpenXR"]
    #[inline]
    pub fn out(next: *mut BaseOutStructure) -> MaybeUninit<Self> {
        let mut x = MaybeUninit::<Self>::uninit();
...
#[repr(C)]
#[derive(Copy, Clone)]
#[doc = "See [XrFrameEndSecondaryViewConfigurationInfoMSFT](https://www.khronos.org/registry/OpenXR/specs/1.0/html/xrspec.html#XrFrameEndSecondaryViewConfigurationInfoMSFT) - defined by [XR_MSFT_secondary_view_configuration_preview](https://www.khronos.org/registry/OpenXR/specs/1.0/html/xrspec.html#XR_MSFT_secondary_view_configuration_preview)"]
pub struct FrameEndSecondaryViewConfigurationInfoMSFT {
    pub ty: StructureType,
    pub next: *const c_void,
    pub view_configuration_count: u32,
    pub view_configuration_layers_info: *const SecondaryViewConfigurationLayerInfoMSFT,
}
impl FrameEndSecondaryViewConfigurationInfoMSFT {
    pub const TYPE: StructureType = StructureType::FRAME_END_SECONDARY_VIEW_CONFIGURATION_INFO_MSFT;
}
#[repr(C)]
#[derive(Copy, Clone)]
#[doc = "See [XrSecondaryViewConfigurationLayerInfoMSFT](https://www.khronos.org/registry/OpenXR/specs/1.0/html/xrspec.html#XrSecondaryViewConfigurationLayerInfoMSFT) - defined by [XR_MSFT_secondary_view_configuration_preview](https://www.khronos.org/registry/OpenXR/specs/1.0/html/xrspec.html#XR_MSFT_secondary_view_configuration_preview)"]
...
#[repr(C)]
#[derive(Copy, Clone)]
#[doc = "See [XrSwapchainSecondaryViewConfigurationCreateInfoMSFT](https://www.khronos.org/registry/OpenXR/specs/1.0/html/xrspec.html#XrSwapchainSecondaryViewConfigurationCreateInfoMSFT) - defined by [XR_MSFT_secondary_view_configuration_preview](https://www.khronos.org/registry/OpenXR/specs/1.0/html/xrspec.html#XR_MSFT_secondary_view_configuration_preview)"]
pub struct SwapchainSecondaryViewConfigurationCreateInfoMSFT {
    pub ty: StructureType,
    pub next: *const c_void,
    pub view_configuration_type: ViewConfigurationType,
}
impl SwapchainSecondaryViewConfigurationCreateInfoMSFT {
    pub const TYPE: StructureType =
        StructureType::SWAPCHAIN_SECONDARY_VIEW_CONFIGURATION_CREATE_INFO_MSFT;
}
#[repr(C)]
#[derive(Copy, Clone)]
#[doc = "See [XrActionStatePoseControllerModelMSFT](https://www.khronos.org/registry/OpenXR/specs/1.0/html/xrspec.html#XrActionStatePoseControllerModelMSFT) - defined by [XR_MSFT_controller_model_preview](https://www.khronos.org/registry/OpenXR/specs/1.0/html/xrspec.html#XR_MSFT_controller_model_preview)"]
pub struct ActionStatePoseControllerModelMSFT {
    pub ty: StructureType,
    pub next: *mut c_void,
    pub model_key_valid: Bool32,
    pub model_key: ControllerModelKeyMSFT,
}
impl ActionStatePoseControllerModelMSFT {
    pub const TYPE: StructureType = StructureType::ACTION_STATE_POSE_CONTROLLER_MODEL_MSFT;
    #[doc = r" Construct a partially-initialized value suitable for passing to OpenXR"]
    #[inline]
    pub fn out(next: *mut BaseOutStructure) -> MaybeUninit<Self> {
        let mut x = MaybeUninit::<Self>::uninit();
...
#[repr(C)]
#[derive(Copy, Clone)]
#[doc = "See [XrControllerModelNodePropertiesMSFT](https://www.khronos.org/registry/OpenXR/specs/1.0/html/xrspec.html#XrControllerModelNodePropertiesMSFT) - defined by [XR_MSFT_controller_model_preview](https://www.khronos.org/registry/OpenXR/specs/1.0/html/xrspec.html#XR_MSFT_controller_model_preview)"]
pub struct ControllerModelNodePropertiesMSFT {
    pub ty: StructureType,
    pub next: *mut c_void,
    pub parent_node_name_xr_max_controller_model_node_name_size_msft: c_char,
    pub node_name_xr_max_controller_model_node_name_size_msft: c_char,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
#[doc = "See [XrControllerModelPropertiesMSFT](https://www.khronos.org/registry/OpenXR/specs/1.0/html/xrspec.html#XrControllerModelPropertiesMSFT) - defined by [XR_MSFT_controller_model_preview](https://www.khronos.org/registry/OpenXR/specs/1.0/html/xrspec.html#XR_MSFT_controller_model_preview)"]
...
#[repr(C)]
#[derive(Copy, Clone)]
#[doc = "See [XrControllerModelNodeStateMSFT](https://www.khronos.org/registry/OpenXR/specs/1.0/html/xrspec.html#XrControllerModelNodeStateMSFT) - defined by [XR_MSFT_controller_model_preview](https://www.khronos.org/registry/OpenXR/specs/1.0/html/xrspec.html#XR_MSFT_controller_model_preview)"]
...
#[repr(C)]
#[derive(Copy, Clone)]
#[doc = "See [XrControllerModelStateMSFT](https://www.khronos.org/registry/OpenXR/specs/1.0/html/xrspec.html#XrControllerModelStateMSFT) - defined by [XR_MSFT_controller_model_preview](https://www.khronos.org/registry/OpenXR/specs/1.0/html/xrspec.html#XR_MSFT_controller_model_preview)"]
...
pub mod pfn {
    ...
    #[doc = "See [xrCreateSpaceFromSpatialGraphNodeMSFT](https://www.khronos.org/registry/OpenXR/specs/1.0/html/xrspec.html#xrCreateSpaceFromSpatialGraphNodeMSFT) - defined by [XR_MSFT_spatial_graph_bridge_preview](https://www.khronos.org/registry/OpenXR/specs/1.0/html/xrspec.html#XR_MSFT_spatial_graph_bridge_preview)"]
    pub type CreateSpaceFromSpatialGraphNodeMSFT = unsafe extern "system" fn(
        session: Session,
        space_create_info: *const SpaceFromSpatialGraphNodeCreateInfoMSFT,
        space: *mut Space,
    ) -> Result;
    #[doc = "See [xrCreateHandTrackerMSFT](https://www.khronos.org/registry/OpenXR/specs/1.0/html/xrspec.html#xrCreateHandTrackerMSFT) - defined by [XR_MSFT_hand_tracking_preview](https://www.khronos.org/registry/OpenXR/specs/1.0/html/xrspec.html#XR_MSFT_hand_tracking_preview)"]
    pub type CreateHandTrackerMSFT = unsafe extern "system" fn(
        session: Session,
        create_info: *const HandTrackerCreateInfoMSFT,
        hand_tracker: *mut HandTrackerMSFT,
    ) -> Result;
    #[doc = "See [xrDestroyHandTrackerMSFT](https://www.khronos.org/registry/OpenXR/specs/1.0/html/xrspec.html#xrDestroyHandTrackerMSFT) - defined by [XR_MSFT_hand_tracking_preview](https://www.khronos.org/registry/OpenXR/specs/1.0/html/xrspec.html#XR_MSFT_hand_tracking_preview)"]
    pub type DestroyHandTrackerMSFT =
        unsafe extern "system" fn(hand_tracker: HandTrackerMSFT) -> Result;
    #[doc = "See [xrGetHandTrackerStateMSFT](https://www.khronos.org/registry/OpenXR/specs/1.0/html/xrspec.html#xrGetHandTrackerStateMSFT) - defined by [XR_MSFT_hand_tracking_preview](https://www.khronos.org/registry/OpenXR/specs/1.0/html/xrspec.html#XR_MSFT_hand_tracking_preview)"]
    pub type GetHandTrackerStateMSFT = unsafe extern "system" fn(
        hand_tracker: HandTrackerMSFT,
        time: Time,
        state: *mut HandTrackerStateMSFT,
    ) -> Result;
    #[doc = "See [xrCreateHandJointSpaceMSFT](https://www.khronos.org/registry/OpenXR/specs/1.0/html/xrspec.html#xrCreateHandJointSpaceMSFT) - defined by [XR_MSFT_hand_tracking_preview](https://www.khronos.org/registry/OpenXR/specs/1.0/html/xrspec.html#XR_MSFT_hand_tracking_preview)"]
    pub type CreateHandJointSpaceMSFT = unsafe extern "system" fn(
        session: Session,
        create_info: *const HandJointSpaceCreateInfoMSFT,
        space: *mut Space,
    ) -> Result;
    #[doc = "See [xrCreateHandMeshSpaceMSFT](https://www.khronos.org/registry/OpenXR/specs/1.0/html/xrspec.html#xrCreateHandMeshSpaceMSFT) - defined by [XR_MSFT_hand_tracking_mesh_preview](https://www.khronos.org/registry/OpenXR/specs/1.0/html/xrspec.html#XR_MSFT_hand_tracking_mesh_preview)"]
    pub type CreateHandMeshSpaceMSFT = unsafe extern "system" fn(
        session: Session,
        create_info: *const HandMeshSpaceCreateInfoMSFT,
        space: *mut Space,
    ) -> Result;
    #[doc = "See [xrUpdateHandMeshMSFT](https://www.khronos.org/registry/OpenXR/specs/1.0/html/xrspec.html#xrUpdateHandMeshMSFT) - defined by [XR_MSFT_hand_tracking_mesh_preview](https://www.khronos.org/registry/OpenXR/specs/1.0/html/xrspec.html#XR_MSFT_hand_tracking_mesh_preview)"]
    pub type UpdateHandMeshMSFT = unsafe extern "system" fn(
        hand_tracker: HandTrackerMSFT,
        update_info: *const HandMeshUpdateInfoMSFT,
        hand_mesh: *mut HandMeshMSFT,
    ) -> Result;
    #[doc = "See [xrLoadControllerModelMSFT](https://www.khronos.org/registry/OpenXR/specs/1.0/html/xrspec.html#xrLoadControllerModelMSFT) - defined by [XR_MSFT_controller_model_preview](https://www.khronos.org/registry/OpenXR/specs/1.0/html/xrspec.html#XR_MSFT_controller_model_preview)"]
    ...
    #[doc = "See [xrGetControllerModelPropertiesMSFT](https://www.khronos.org/registry/OpenXR/specs/1.0/html/xrspec.html#xrGetControllerModelPropertiesMSFT) - defined by [XR_MSFT_controller_model_preview](https://www.khronos.org/registry/OpenXR/specs/1.0/html/xrspec.html#XR_MSFT_controller_model_preview)"]
    pub type GetControllerModelPropertiesMSFT = unsafe extern "system" fn(
        session: Session,
        model_key: ControllerModelKeyMSFT,
        properties: *mut ControllerModelPropertiesMSFT,
    ) -> Result;
    #[doc = "See [xrGetControllerModelStateMSFT](https://www.khronos.org/registry/OpenXR/specs/1.0/html/xrspec.html#xrGetControllerModelStateMSFT) - defined by [XR_MSFT_controller_model_preview](https://www.khronos.org/registry/OpenXR/specs/1.0/html/xrspec.html#XR_MSFT_controller_model_preview)"]
...
pub const MSFT_spatial_graph_bridge_preview_SPEC_VERSION: u32 = 1u32;
pub const MSFT_SPATIAL_GRAPH_BRIDGE_PREVIEW_EXTENSION_NAME: &[u8] =
    b"XR_MSFT_spatial_graph_bridge_preview\0";
pub const MSFT_hand_tracking_preview_SPEC_VERSION: u32 = 1u32;
pub const MSFT_HAND_TRACKING_PREVIEW_EXTENSION_NAME: &[u8] = b"XR_MSFT_hand_tracking_preview\0";
pub const MSFT_hand_tracking_mesh_preview_SPEC_VERSION: u32 = 1u32;
pub const MSFT_HAND_TRACKING_MESH_PREVIEW_EXTENSION_NAME: &[u8] =
    b"XR_MSFT_hand_tracking_mesh_preview\0";
pub const MSFT_secondary_view_configuration_preview_SPEC_VERSION: u32 = 1u32;
pub const MSFT_SECONDARY_VIEW_CONFIGURATION_PREVIEW_EXTENSION_NAME: &[u8] =
    b"XR_MSFT_secondary_view_configuration_preview\0";
pub const MSFT_first_person_observer_preview_SPEC_VERSION: u32 = 1u32;
pub const MSFT_FIRST_PERSON_OBSERVER_PREVIEW_EXTENSION_NAME: &[u8] =
    b"XR_MSFT_first_person_observer_preview\0";
pub const MSFT_controller_model_preview_SPEC_VERSION: u32 = 1u32;
pub const MSFT_CONTROLLER_MODEL_PREVIEW_EXTENSION_NAME: &[u8] =
    b"XR_MSFT_controller_model_preview\0";
#[cfg(target_os = "android")]
