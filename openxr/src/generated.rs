...
pub use sys::{
    ...
    Extent2Df, Extent2Di, EyeVisibility, FormFactor, Fovf, HandJointMSFT, HandMSFT,
    HandMeshVertexMSFT, HandPoseTypeMSFT, InputSourceLocalizedNameFlags, InstanceCreateFlags,
    ObjectType, Offset2Df, Offset2Di, OverlayMainSessionFlagsEXTX, OverlaySessionCreateFlagsEXTX,
    PerfSettingsDomainEXT, PerfSettingsLevelEXT, PerfSettingsNotificationLevelEXT,
    PerfSettingsSubDomainEXT, Posef, Quaternionf, Rect2Df, Rect2Di, ReferenceSpaceType,
    SessionCreateFlags, SessionState, SpaceLocationFlags, SpaceVelocityFlags,
    SpatialGraphNodeTypeMSFT, StructureType, SwapchainCreateFlags, SwapchainUsageFlags,
...
pub struct ExtensionSet {
    ...
    pub msft_spatial_graph_bridge_preview: bool,
    pub msft_hand_tracking_preview: bool,
    pub msft_hand_tracking_mesh_preview: bool,
    pub msft_secondary_view_configuration_preview: bool,
    pub msft_first_person_observer_preview: bool,
    pub msft_controller_model_preview: bool,
    #[cfg(target_os = "android")]
...
impl ExtensionSet {
    pub(crate) fn from_properties(properties: &[sys::ExtensionProperties]) -> Self {
        ...
        for ext in properties {
            match crate::fixed_str_bytes(&ext.extension_name) {
                ...
                raw::SpatialGraphBridgePreviewMSFT::NAME => {
                    out.msft_spatial_graph_bridge_preview = true;
                }
                raw::HandTrackingPreviewMSFT::NAME => {
                    out.msft_hand_tracking_preview = true;
                }
                raw::HandTrackingMeshPreviewMSFT::NAME => {
                    out.msft_hand_tracking_mesh_preview = true;
                }
                raw::SecondaryViewConfigurationPreviewMSFT::NAME => {
                    out.msft_secondary_view_configuration_preview = true;
                }
                raw::FirstPersonObserverPreviewMSFT::NAME => {
                    out.msft_first_person_observer_preview = true;
                }
                raw::ControllerModelPreviewMSFT::NAME => {
                    out.msft_controller_model_preview = true;
                }
                #[cfg(target_os = "android")]
    ...
    pub(crate) fn names(&self) -> Vec<Cow<'static, [u8]>> {
        ...
        {
            if self.msft_spatial_graph_bridge_preview {
                out.push(raw::SpatialGraphBridgePreviewMSFT::NAME.into());
            }
        }
        {
            if self.msft_hand_tracking_preview {
                out.push(raw::HandTrackingPreviewMSFT::NAME.into());
            }
        }
        {
            if self.msft_hand_tracking_mesh_preview {
                out.push(raw::HandTrackingMeshPreviewMSFT::NAME.into());
            }
        }
        {
            if self.msft_secondary_view_configuration_preview {
                out.push(raw::SecondaryViewConfigurationPreviewMSFT::NAME.into());
            }
        }
        {
            if self.msft_first_person_observer_preview {
                out.push(raw::FirstPersonObserverPreviewMSFT::NAME.into());
            }
        }
        {
            if self.msft_controller_model_preview {
                out.push(raw::ControllerModelPreviewMSFT::NAME.into());
            }
        }
        #[cfg(target_os = "android")]
        {
...
pub struct InstanceExtensions {
    ...
    pub msft_spatial_graph_bridge_preview: Option<raw::SpatialGraphBridgePreviewMSFT>,
    pub msft_hand_tracking_preview: Option<raw::HandTrackingPreviewMSFT>,
    pub msft_hand_tracking_mesh_preview: Option<raw::HandTrackingMeshPreviewMSFT>,
    pub msft_secondary_view_configuration_preview:
        Option<raw::SecondaryViewConfigurationPreviewMSFT>,
    pub msft_first_person_observer_preview: Option<raw::FirstPersonObserverPreviewMSFT>,
    pub msft_controller_model_preview: Option<raw::ControllerModelPreviewMSFT>,
    #[cfg(target_os = "android")]
...
impl InstanceExtensions {
    ...
    pub unsafe fn load(
        ...
        Ok(Self {
            ...
            msft_spatial_graph_bridge_preview: if required.msft_spatial_graph_bridge_preview {
                Some(raw::SpatialGraphBridgePreviewMSFT::load(entry, instance)?)
            } else {
                None
            },
            msft_hand_tracking_preview: if required.msft_hand_tracking_preview {
                Some(raw::HandTrackingPreviewMSFT::load(entry, instance)?)
            } else {
                None
            },
            msft_hand_tracking_mesh_preview: if required.msft_hand_tracking_mesh_preview {
                Some(raw::HandTrackingMeshPreviewMSFT::load(entry, instance)?)
            } else {
                None
            },
            msft_secondary_view_configuration_preview: if required
                .msft_secondary_view_configuration_preview
            {
                Some(raw::SecondaryViewConfigurationPreviewMSFT {})
            } else {
                None
            },
            msft_first_person_observer_preview: if required.msft_first_person_observer_preview {
                Some(raw::FirstPersonObserverPreviewMSFT {})
            } else {
                None
            },
            msft_controller_model_preview: if required.msft_controller_model_preview {
                Some(raw::ControllerModelPreviewMSFT::load(entry, instance)?)
            } else {
                None
            },
            #[cfg(target_os = "android")]
...
pub mod raw {
    ...
    #[derive(Copy, Clone)]
    pub struct SpatialGraphBridgePreviewMSFT {
        pub create_space_from_spatial_graph_node: pfn::CreateSpaceFromSpatialGraphNodeMSFT,
    }
    impl SpatialGraphBridgePreviewMSFT {
        pub const VERSION: u32 = sys::MSFT_spatial_graph_bridge_preview_SPEC_VERSION;
        pub const NAME: &'static [u8] = sys::MSFT_SPATIAL_GRAPH_BRIDGE_PREVIEW_EXTENSION_NAME;
        #[doc = r" Load the extension's function pointer table"]
        #[doc = r""]
        #[doc = r" # Safety"]
        #[doc = r""]
        ...
        pub unsafe fn load(entry: &Entry, instance: sys::Instance) -> Result<Self> {
            Ok(Self {
                create_space_from_spatial_graph_node: mem::transmute(
                    entry.get_instance_proc_addr(
                        instance,
                        CStr::from_bytes_with_nul_unchecked(
                            b"xrCreateSpaceFromSpatialGraphNodeMSFT\0",
                        ),
                    )?,
                ),
            })
    ...
    #[derive(Copy, Clone)]
    pub struct HandTrackingPreviewMSFT {
        pub create_hand_tracker: pfn::CreateHandTrackerMSFT,
        pub destroy_hand_tracker: pfn::DestroyHandTrackerMSFT,
        pub get_hand_tracker_state: pfn::GetHandTrackerStateMSFT,
        pub create_hand_joint_space: pfn::CreateHandJointSpaceMSFT,
    }
    impl HandTrackingPreviewMSFT {
        pub const VERSION: u32 = sys::MSFT_hand_tracking_preview_SPEC_VERSION;
        pub const NAME: &'static [u8] = sys::MSFT_HAND_TRACKING_PREVIEW_EXTENSION_NAME;
        #[doc = r" Load the extension's function pointer table"]
        #[doc = r""]
        #[doc = r" # Safety"]
        #[doc = r""]
        ...
        pub unsafe fn load(entry: &Entry, instance: sys::Instance) -> Result<Self> {
            Ok(Self {
                create_hand_tracker: mem::transmute(entry.get_instance_proc_addr(
                    instance,
                    CStr::from_bytes_with_nul_unchecked(b"xrCreateHandTrackerMSFT\0"),
                )?),
                destroy_hand_tracker: mem::transmute(entry.get_instance_proc_addr(
                    instance,
                    CStr::from_bytes_with_nul_unchecked(b"xrDestroyHandTrackerMSFT\0"),
                )?),
                get_hand_tracker_state: mem::transmute(entry.get_instance_proc_addr(
                    instance,
                    CStr::from_bytes_with_nul_unchecked(b"xrGetHandTrackerStateMSFT\0"),
                )?),
                create_hand_joint_space: mem::transmute(entry.get_instance_proc_addr(
                    instance,
                    CStr::from_bytes_with_nul_unchecked(b"xrCreateHandJointSpaceMSFT\0"),
                )?),
            })
        }
    }
    #[derive(Copy, Clone)]
    pub struct HandTrackingMeshPreviewMSFT {
        pub create_hand_mesh_space: pfn::CreateHandMeshSpaceMSFT,
        pub update_hand_mesh: pfn::UpdateHandMeshMSFT,
    }
    impl HandTrackingMeshPreviewMSFT {
        pub const VERSION: u32 = sys::MSFT_hand_tracking_mesh_preview_SPEC_VERSION;
        pub const NAME: &'static [u8] = sys::MSFT_HAND_TRACKING_MESH_PREVIEW_EXTENSION_NAME;
        #[doc = r" Load the extension's function pointer table"]
        #[doc = r""]
        #[doc = r" # Safety"]
        #[doc = r""]
    ...
    #[derive(Copy, Clone)]
    pub struct SecondaryViewConfigurationPreviewMSFT {}
    impl SecondaryViewConfigurationPreviewMSFT {
        pub const VERSION: u32 = sys::MSFT_secondary_view_configuration_preview_SPEC_VERSION;
        pub const NAME: &'static [u8] =
            sys::MSFT_SECONDARY_VIEW_CONFIGURATION_PREVIEW_EXTENSION_NAME;
    }
    #[derive(Copy, Clone)]
    pub struct FirstPersonObserverPreviewMSFT {}
    impl FirstPersonObserverPreviewMSFT {
        pub const VERSION: u32 = sys::MSFT_first_person_observer_preview_SPEC_VERSION;
        pub const NAME: &'static [u8] = sys::MSFT_FIRST_PERSON_OBSERVER_PREVIEW_EXTENSION_NAME;
    }
    #[derive(Copy, Clone)]
    pub struct ControllerModelPreviewMSFT {
    ...
    impl ControllerModelPreviewMSFT {
        pub const VERSION: u32 = sys::MSFT_controller_model_preview_SPEC_VERSION;
        pub const NAME: &'static [u8] = sys::MSFT_CONTROLLER_MODEL_PREVIEW_EXTENSION_NAME;
        #[doc = r" Load the extension's function pointer table"]
        #[doc = r""]
        #[doc = r" # Safety"]
        #[doc = r""]
