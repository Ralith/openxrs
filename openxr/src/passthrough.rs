...
use crate::{
    cvt, raw, session, sys, sys::Handle as _, PassthroughFlagsFB, PassthroughLayerPurposeFB,
    Result, Session, SessionInner, XrObject,
};
use std::ptr;
use std::sync::Arc;
...
impl XrObject for PassthroughLayerFB {
